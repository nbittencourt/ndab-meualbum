...
- Name: perfil\perfil.spec.ts >> Perfil do Usuário >> Identificador >> deve exibir identificador de 6 chars em modo somente leitura (RN-P02)
- Location: tests\perfil\perfil.spec.ts:10:9
...
Locator: getByText('B40PTV')
Expected: visible
Error: strict mode violation: getByText('B40PTV') resolved to 2 elements:
    1) <div>#B40PTV</div> aka getByText('#B40PTV')
    2) <span aria-label="Identificador: B 4 0 P T V" class="font-mono text-4xl font-black tracking-[0.25em] text-ink select-all">B40PTV</span> aka getByLabel('Identificador: B 4 0 P T V')

Call log:
  - Expect "toBeVisible" with timeout 3000ms
  - waiting for getByText('B40PTV')
...
- generic [ref=e2]:
  ...
  - generic [ref=e5]:
    - main [ref=e6]:
      - generic [ref=e7]:
        - generic [ref=e8]:
          ...
          - generic [ref=e13]:
            - generic [ref=e14]:
              - generic [ref=e15]: Usuário Teste
              - generic [ref=e16]: "#B40PTV"
        ...
        - generic [ref=e20]:
          ...
          - generic [ref=e22]:
            ...
            - generic [ref=e26]:
              - 'generic "Identificador: B 4 0 P T V" [ref=e27]': B40PTV
              - button "Copiar identificador" [ref=e28]:
                - img [ref=e29]
          - generic [ref=e33]:
            - heading "Nome" [level=2] [ref=e34]
            - generic [ref=e35]:
              - paragraph [ref=e36]: Usuário Teste
              - button "Editar" [ref=e37] [cursor=pointer]
          - generic [ref=e38]:
            - heading "Email" [level=2] [ref=e39]
            - paragraph [ref=e40]: teste+1780587511856_apvvox@exemplo.com
    ...
    - contentinfo [ref=e94]:
      - navigation "Links de rodapé" [ref=e95]:
        - link "Política de Privacidade (abre em nova aba)" [ref=e96] [cursor=pointer]:
          - /url: /politica-de-privacidade
          - text: Política de Privacidade
          - generic [ref=e97]: (abre em nova aba)
        - link "Gerenciar cookies" [ref=e98] [cursor=pointer]:
          - /url: /perfil#cookies
```
