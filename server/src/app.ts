...
/**
 * Monta a aplicação Express sem efeitos colaterais (sem listen/conexão de banco),
 * permitindo uso tanto pelo bootstrap (index.ts) quanto por testes de integração.
 */
